...
//  uFreelance
//
//  Created by Vasily Ulianov on 21.11.16.
...
class AppDelegate: NSObject, NSApplicationDelegate {
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
	    ...
	    let modelURL = Bundle.main.url(forResource: "uFreelance", withExtension: "momd")!
	...
	lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
	    ...
	    if failError == nil {
	        ...
	        let url = self.applicationDocumentsDirectory.appendingPathComponent("uFreelance.storedata")
	        do {
